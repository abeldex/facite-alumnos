...
<main id="col-main">	
			<div class="dashboard-container">
				...
				<div class="row">
                    <div class="col-12" >    
                        <center><h2 class="text-primary">Crear tu Curriculum Vitae</h2> </center>
                        <!--
                       ...
                       -->
                        <ul class="nav nav-tabs dashboard-sub-menu nav-justified" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-datos" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">1. Datos Personales</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-contenido" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">2. Contenido</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-descarga" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">3. Descargar</a>
                            </li>
                        </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12  col-lg-3">
                                                <div id="account-edit-photo">
                                                    <div><img id="foto" src="http://distribuidorde10.com/wp-content/uploads/2018/06/no_existe_segunda_oportunidad.gif" alt="Account Image"></div>
                                                    <p>
                                                    <!-- seleccionar foto de perfil -->
                                                    <a class="btn btn-green-pro" id="add_foto" id="btn_subir">Seleccionar una foto</a>
                                        ...
                                        <div class="col">
                                            ...
                                            <hr>
                                            <p><a href="#" class="btn btn-green-pro" id="btn_guardar_datos">Guardar Datos Personales</a></p>
                                            <br>
                                            </form>
                                ...
                                <div id="accordion">
                                    <div class="card">
                                        ...
                                        <h5 class="mb-0">
                                            ...
                                            <i class="fas fa-graduation-cap"></i>  Formación Académica <i class="fas fa-caret-down"></i>
                                            </a>
                                        </h5>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <hr>
                                            <a class="btn btn-green-pro text-white" id="add_formacion"><i class="fas fa-plus"></i>Añadir Formación</a>
                                            <hr>
                                    ...
                                    <form id="form_experiencia" name="form_experiencia">
                                        ...
                                        <div class="row">
                                            ...
                                            <hr>
                                            <a class="btn btn-green-pro text-white" id="add_experiencia"><i class="fas fa-plus"></i>Añadir Experiencia</a>
                                    ...
                                    <form id="form_habilidades" name="form_habilidades">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <hr>
                                            <a class="btn btn-green-pro text-white" id="add_habilidad"><i class="fas fa-plus"></i>Añadir Habilidad</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <hr>
                                            <a class="btn btn-green-pro text-white" id="add_interes"><i class="fas fa-plus"></i>Añadir interés</a>
                                            <hr>
                                    ...
                                    <form id="form_idiomas" name="form_idiomas">     
                                        ...
                                        <div class="row">
                                            ...
                                            <hr>
                                            <a class="btn btn-green-pro text-white" id="add_idioma"><i class="fas fa-plus"></i>Añadir idioma</a>
                                            <hr>
                                            <div id="idiomas_list">
                                                <!-- aqui ira la informacion de las formaciones almacenadas -->
                                                <ul class="list-group">
